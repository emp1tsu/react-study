...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"ColorBox.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function ColorBox(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ColorBox).call(this, props));
    _this.state = {
      index: -1,
      colorName: '',
  ...
  _createClass(ColorBox, [{
    ...
    value: function render() {
      ...
      var index = this.state.index; // 選択中の色

      var currentColor = 0 <= index ? colors[index] : '';
      var items = colors.map(function (color) {
        var frame = '1px solid white';
        ...
        var clickHandler = function clickHandler(e) {
          var c = e.target.style.color;

          var i = _this2.state.colors.indexOf(c);

          _this2.setState({
            index: i
          });

          if (_this2.props.onColorChange) _this2.props.onColorChange({
            color: c
          });
        };
...
var colorHandler = function colorHandler(e) {
  _reactDom.default.render(_react.default.createElement("p", null, e.color), document.getElementById('info'));
};

_reactDom.default.render(_react.default.createElement("div", null, _react.default.createElement(_ColorBox.default, {
  id: "cb",
  onColorChange: colorHandler
})), document.getElementById('root'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./ColorBox":"ColorBox.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
